        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="alert alert-info" role="alert">
                    ...
                    @endif()
                <form action="{{ route('admin_users.store') }}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body card-block">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Vui lòng diền tên" class="form-control">
                                <span class="invalid-feedback" style="display:block;">
                            @if ($errors->has('name'))
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="email" id="email" value="{{ old('email') }}" placeholder="Vui lòng diền tên" class="form-control">
                                <span class="invalid-feedback" style="display:block;">
                            @if ($errors->has('email'))
                            <div class="alert alert-success" role="alert">
                                <span class="invalid-feedback" style="display:block;">
